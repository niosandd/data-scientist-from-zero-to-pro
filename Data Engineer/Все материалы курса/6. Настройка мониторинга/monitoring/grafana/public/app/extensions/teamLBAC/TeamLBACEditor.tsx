...
import { type DataSourceJsonData, type DataSourceSettings, type GrafanaTheme2 } from '@grafana/data';
...
import { AccessControlAction as EnterpriseActions, type EnterpriseStoreState, type TeamRule } from '../types';

import { CreateTeamLBACForm, type LBACFormData } from './AddTeamLBACForm';
...
const TeamLBACEditorUnconnected = ({
  teamLBACRules,
  storedDatasourceUid,
  dataSourceConfig,
  readOnly,
              ...
              <Box marginBottom={2}>
                <Text variant="bodySmall">
                  {sortedAndFilteredRules.length === 1
                    ...
                    : t('team-lbac.team-lbaceditor-unconnected.filter-results-multiple', '', {
                        count: sortedAndFilteredRules.length,
                        defaultValue_one: 'Showing {{count}} results',
                        defaultValue_other: 'Showing {{count}} results',
                      })}
                  <Button
                    onClick={clearFilter}
                    fill="text"
