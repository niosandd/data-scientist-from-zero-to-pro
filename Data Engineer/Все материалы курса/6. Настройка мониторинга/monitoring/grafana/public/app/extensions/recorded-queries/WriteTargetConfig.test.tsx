...
import { type DataSourceInstanceSettings, type NavModel } from '@grafana/data';
import { type DataSourcePickerProps } from '@grafana/runtime';
import { getRouteComponentProps } from 'app/core/navigation/mocks/routeProps';

import { type PrometheusWriteTarget } from '../types';

import { WriteTargetConfigUnconnected, type Props } from './WriteTargetConfig';
