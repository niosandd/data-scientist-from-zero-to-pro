...
import { AppEvents, type DataSourceInstanceSettings, type GrafanaTheme2 } from '@grafana/data';
...
import { type EnterpriseStoreState, type PrometheusWriteTarget } from '../types';
