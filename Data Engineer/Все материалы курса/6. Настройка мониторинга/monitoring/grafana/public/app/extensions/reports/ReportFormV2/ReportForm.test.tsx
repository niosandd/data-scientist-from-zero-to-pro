...
import { ReportSchedulingFrequencyV2, ReportState, type ReportV2, SendTime } from '../../types';
...
describe('ReportForm', () => {
  ...
  describe('Dashboards functionality', () => {
    ...
    it('should handle dashboard without variables correctly', async () => {
      ...
      jest.spyOn(require('app/features/dashboard/api/dashboard_api'), 'getDashboardAPI').mockResolvedValue({
