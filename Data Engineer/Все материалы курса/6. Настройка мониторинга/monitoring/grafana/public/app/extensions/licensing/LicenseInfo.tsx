...
import { CardAlert, CardContent, type CardState, LicenseCard } from './LicenseCard';
...
import { type ActiveUserStats, type LicenseToken } from './types';
import {
                  ...
                  ...(config.anonymousEnabled
                    ? [
                        ...
                        },
                        {
                          ...
                          tooltip: t('licensing.license-info.card-content-anonymous-users-tooltip', '', {
                            count: anonymousRatio,
                            defaultValue_one: 'For every {{count}} anonymous devices, Grafana counts 1 user.',
                            defaultValue_other: 'For every {{count}} anonymous devices, Grafana counts 1 user.',
                          }),
                          indentLevel: 1,
                        },
                      ]
