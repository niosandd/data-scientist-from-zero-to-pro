import { type SceneGridItemLike, SceneGridRow, VizPanel } from '@grafana/scenes';

import { DashboardGridItem } from '../../../features/dashboard-scene/scene/layout-default/DashboardGridItem';

import { A4_HEIGHT, A4_WIDTH, DEFAULT_FOOTER_HEIGHT } from './ReportGridRenderer';
...
describe('buildGridLayout', () => {
  it('should build correct layout for large panels and rows', () => {
    ...
    const scale = 1.5;
    const pages = buildGridLayout(dashboardItems, scale, (A4_HEIGHT - 110 - DEFAULT_FOOTER_HEIGHT) * scale);
  ...
  it('panels with the same Y position should remain in the same page', () => {
    ...
    const scale = 1;
    const pages = buildGridLayout(dashboardItems, scale, (A4_WIDTH - 92 - DEFAULT_FOOTER_HEIGHT) * scale);
  ...
  it('should build correct layout for horizontal repeated panels within repeating rows', async () => {
    ...
    const scale = 1;
    const pages = buildGridLayout(dashboardItems, scale, (A4_WIDTH - 110 - DEFAULT_FOOTER_HEIGHT) * scale);
