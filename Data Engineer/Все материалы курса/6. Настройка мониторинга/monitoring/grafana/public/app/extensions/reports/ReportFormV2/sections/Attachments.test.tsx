...
import { type ReportFormV2 } from '../../../types';

import Attachments from './Attachments';
import { SelectDashboardScene, type SelectDashboardState } from './SelectDashboards/SelectDashboardScene';
...
describe('Attachments', () => {
  ...
  describe('CSV encoding', () => {
    ...
    it('should render Combobox when CSV is selected', async () => {
      const user = userEvent.setup();
      render(<AttachmentsWrapper />);
